...
<html lang="en">
    ...
    <head>
        ...
        <title>Bootstrap Modal Login Form Templates</title>
    ...
    <body>
    	...
    	<div class="top">
    		<h1>Bootstrap Modal Login Form Templates</h1>
    		<p>
				These are 2 free responsive modal login form templates made with Bootstrap. 
	            	...
	            	<div class="col-sm-10 col-sm-offset-1">
	            		<div class="row">
		                	<div class="col-sm-6 layout-box">
			                	...
			                	<p>Form 1: light modal login form</p>
		                    </div>
		                    <div class="col-sm-6 layout-box">
		                    	<a href="form-2/index.html">
				                	<img src="choose-layout-assets/2.jpg" alt="">
			                    </a>
			                    <p>Form 2: dark modal login form</p>
		                    </div>
	                    </div>
                    </div>
	            </div>
        ...
        <div class="container footer">
            <div class="row">
                <div class="col-sm-12">
                	&copy; Bootstrap Modal Login Form Templates by <a href="http://azmind.com" target="_blank">Azmind</a>.
                </div>
            </div>
        </div>
