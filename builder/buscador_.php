...
<div class="hidden-xs">
  <div id="ctBuscador" class="buscadorFijo" style="display:none;">
	...
	while ($rango=mysql_fetch_array($ran))
	{
      ...
      <div style="padding-bottom:4px;">
        <input name="busca" type="text" class="form-control" id="busca" placeholder="Buscar por Palabra">
      </div>
      <div>
  ...
  <div id="ctBtnBuscador" class="buscadorFijo">
